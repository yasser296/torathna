          ...
          {[
            {
              ...
              description:
                "Chaque tapis raconte une histoire à travers ses motifs géométriques et symboliques.",
              image: "/images/tapis berbere.jpeg",
            },
            {
              title: "Poterie & Céramique",
              description:
                "Art millénaire qui se manifeste dans des œuvres utilitaires et décoratives.",
              image: "/images/poteri.avif",
            },
            {
              title: "Bijouterie Traditionnelle",
              description:
                "Création de parures en argent incrustées de pierres et d'émaux colorés.",
              image: "/images/bijou.avif",
            },
            {
              title: "Travail du Bois",
              description:
                "Sculptures, mobilier et objets décorés avec minutie par des artisans chevronnés.",
              image: "/images/bois.jpeg",
            },
            {
              title: "Maroquinerie",
              description:
                "Transformation des peaux en produits durables aux finitions raffinées.",
              image: "/images/jeld.jpeg",
            },
            {
              title: "Zellige",
              description:
                "Art de la mosaïque géométrique qui orne palais, mosquées et demeures.",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-card rounded-xl overflow-hidden shadow-md flex flex-col md:flex-row">
            <div className="md:w-2/5">
              <img
                src="public/images/Poitier.jpeg"
                alt="Maître Potier"
            ...
            <div className="p-6 md:w-3/5">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm text-muted-foreground">
                  Maître Artisan depuis 1978
                </span>
              </div>
              <h3 className="text-2xl mb-2">Hassan Mokhtar</h3>
              <h4 className="text-primary mb-4">Maître Potier à Safi</h4>
              <p className="text-muted-foreground mb-4">
                "La poterie est un dialogue entre la terre, l'eau, l'air et le
                feu. Chaque pièce est unique et raconte une histoire
                millénaire."
              </p>
              <p className="text-sm">
                Hassan perpétue des techniques ancestrales de poterie,
                transmises par son père et son grand-père. Son atelier accueille
                des apprentis du monde entier.
              </p>
            </div>
          </div>
          ...
          <div className="bg-card rounded-xl overflow-hidden shadow-md flex flex-col md:flex-row">
            <div className="md:w-2/5">
              <img
                src="public/images/taznakht.jpg"
                alt="Tisserande"
                className="w-full h-full object-cover"
              />
            </div>
            <div className="p-6 md:w-3/5">
              ...
              <p className="text-muted-foreground mb-4">
                "Chaque tapis que je tisse contient des symboles qui racontent
                l'histoire de ma famille, de ma tribu et de notre rapport à la
                nature."
              </p>
              <p className="text-sm">
                Fatima dirige une coopérative de femmes tisserandes qui perpétue
                les motifs traditionnels tout en innovant avec des designs
                contemporains.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-6 border rounded-xl text-center">
            ...
            <p className="text-muted-foreground">
              Les formes géométriques représentent l'ordre cosmique et
              l'harmonie divine dans la tradition islamique.
            </p>
          </div>
          ...
          <div className="p-6 border rounded-xl text-center">
            ...
            <p className="text-muted-foreground">
              Les triangles, losanges et zigzags évoquent les montagnes, l'eau,
              la fertilité et la protection.
            </p>
          </div>
          ...
          <div className="p-6 border rounded-xl text-center">
            ...
            <p className="text-muted-foreground">
              Symbole de protection présent dans de nombreuses créations
              artisanales, elle repousse le mauvais œil.
            </p>
          </div>
        </div>
      </FeatureSection>
