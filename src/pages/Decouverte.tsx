        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-card p-6 rounded-xl shadow-sm">
            ...
            <p className="text-muted-foreground mb-4">
              Découvrez les traditions vocales des régions montagneuses,
              transmises de génération en génération.
            </p>
            <img
              src="public/images/amazigh.jpg"
              alt="Chants Amazighs"
          ...
          <div className="bg-card p-6 rounded-xl shadow-sm">
            ...
            <p className="text-muted-foreground mb-4">
              Explorez les origines et significations de cette forme
              d'expression culturelle et spirituelle.
            </p>
            <img
              src="public/images/Gnaoua.jpg"
              alt="Danse Gnaoua"
              className="w-full h-40 object-cover rounded-lg"
            />
          </div>
          ...
          <div className="bg-card p-6 rounded-xl shadow-sm">
            ...
            <p className="text-muted-foreground mb-4">
              Les techniques ancestrales de tissage varient selon les régions,
              chacune avec ses motifs distinctifs.
            </p>
            <img
              src="public/images/femme_tissage.jpg"
