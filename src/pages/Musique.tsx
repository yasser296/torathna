...
const audioTracks = [
  {
    id: 1,
    title: " Andalousie Marocaine",
    artist: "Orchestre de Fès",
    duration: "6:24",
    region: "Fès",
    image: "/public/images/La-Musique-Andalousie-1.jpg",
  },
  {
    id: 2,
    title: "Ahouach des Atlas",
    artist: "Groupe Folklorique d'Ouarzazate",
    duration: "8:45",
    region: "Souss-Massa",
    image: "public/images/Ahwach.png",
  },
  {
    id: 3,
    title: "Gnaoua Essaouira",
    artist: "Maâlem Hassan Boussou",
    duration: "10:12",
    region: "Marrakech-Safi",
    image: "public/images/gnaoua.jpg",
  },
  {
    id: 4,
    title: "Chaâbi Populaire",
    artist: "Orchestre National",
    duration: "7:38",
    region: "Casablanca",
    image: "public/images/Stati.jpg",
  },
  // {
  //   id: 5,
  //   title: "Izlan Rif",
  ...
  {
    id: 6,
    title: "Malhoun Meknassi",
    artist: "Haj Mohamed Bouzoubaâ",
    duration: "9:53",
    region: "Fès-Meknès",
    image: "public/images/Le-Malhoun.jpg",
  },
];
...
const videoContent = [
  {
    id: 1,
    title: "Festival de Fès des Musiques Sacrées",
    thumbnail: "public/images/festiccva.jpeg",
    duration: "15:42",
  },
  {
    id: 2,
    title: "Les Danses Ahidous de l'Atlas",
    thumbnail: "public/images/ahidouss.jpg",
    duration: "8:17",
  },
  {
    id: 3,
    title: "Le Moussem d'Imilchil",
    thumbnail: "public/images/festival-imilchil.jpg",
    duration: "12:05",
  },
];
            ...
            <div className="flex flex-col space-y-4">
              <div className="flex items-center gap-4 p-3 hover:bg-muted rounded-lg transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Instrument à cordes pincées emblématique de la musique
                    arabo-andalouse
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-3 hover:bg-muted rounded-lg transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Tambour sur cadre utilisé dans diverses traditions musicales
                    marocaines
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-3 hover:bg-muted rounded-lg transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Castagnettes métalliques utilisées dans la musique Gnaoua
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col space-y-4">
              <div className="flex items-center gap-4 p-3 hover:bg-muted rounded-lg transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Instrument à vent puissant utilisé lors des célébrations
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-3 hover:bg-muted rounded-lg transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Instrument à cordes frottées présent dans plusieurs
                    traditions rurales
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-3 hover:bg-muted rounded-lg transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Instrument à cordes à la sonorité grave, central dans la
                    musique Gnaoua
                  </p>
                </div>
              </div>
