        ...
        <Tabs defaultValue="Couscous" className="max-w-5xl mx-auto">
          ...
          <TabsContent value="Couscous" className="animate-fade-in">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                <img 
                  src="public\images\couscous.jpeg" 
                  alt="Couscous" 
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="card-moroccan">
            ...
            <img 
              src="public\images\cousousier.jpeg" 
              alt="Couscoussier" 
              className="rounded-lg mb-3 h-40 w-full object-cover"
            />
            <p className="text-muted-foreground">
          ...
          <div className="card-moroccan">
            <h3 className="text-xl font-bold mb-3">Le Mokraj</h3>
            <img 
              src="public\images\mokraj.jpeg" 
              alt="Mokraj" 
              className="rounded-lg mb-3 h-40 w-full object-cover"
            />
            <p className="text-muted-foreground">
